...
class XZXWSpider(CrawlSpider):
    ...
    def parse(self, response):
        ...
        temp_type = response.selector.xpath('//div[@class="nszw"]/p/a[3]/text()').extract_first(default="None")
        data_type = response.selector.xpath('//body/div[3]/a[3]/text()').extract_first(default=temp_type)
